...
```bash
wget -O lvhy.sh https://raw.githubusercontent.com/fireforce088/vlhy2/main/lvhy.sh && chmod +x lvhy.sh && ./lvhy.sh
```
或者
```bash
bash <(curl -sSL https://raw.githubusercontent.com/fireforce088/vlhy2/main/lvhy.sh)
```
